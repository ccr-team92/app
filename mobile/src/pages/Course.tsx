  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        <Text style={styles.title}>Curso 1</Text>
        <Text style={styles.description}>Descrição do curso</Text>
        </View>
      
        <View style={styles.separator} />

        <Text style={styles.title}>Conteúdo</Text>
        <Text style={styles.description}>Acesse abaixo o conteúdo do curso</Text>
