...
export default function CourseListC() {
        ...
        <View style={styles.container}>
          ...
          <View style={styles.courseCategory}>
            ...
            <TouchableOpacity style={styles.squareB}>
              <Text style={styles.textGray}>ESTUDE O QUE AMA</Text>
              <Image style={{width:25, height:24}} source={require('./assets/love.png')} />
            </TouchableOpacity>
            <TouchableOpacity style={styles.squareC}>
              <Text style={styles.text}>SE CONHEÇA MELHOR</Text>
              <Image style={{width:27, height:24}} source={require('./assets/starWhite.png')} />
            </TouchableOpacity>
          </View>
